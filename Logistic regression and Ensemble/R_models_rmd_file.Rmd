...
for (i in 1:16){
  ...
  Accuracy_test_under[i] <- (confusion_test_under[1,1] + confusion_test_under[2,2])/(confusion_test_under[1,1] + confusion_test_under[1,2] + confusion_test_under[2,1] + confusion_test_under[2,2])
...
#  confusion_test_over
#  Accuracy_test_over[i] <- (confusion_test_over[1,1] + confusion_test_over[2,2])/(confusion_test_over[1,1] + confusion_test_over[1,2]+ confusion_test_over[2,1] + confusion_test_over[2,2])
