...
#we plot the elbow curve as we want to minimize the within cluster sum of squares
...
#we observe that after k =8 within-cluster dissimilarity is not substantial, hence k =8 is optimal, using the orignal dataset
...
plot(Data2, col =(km2$cluster +1) , main="K-Means result with 8 clusters")
